...
Just copy the "cache.js":http://github.com/guilhermechapiewski/titanium-cache/blob/master/cache.js to your project and include it (only once) from your *app.js* file.

After that, the caching functions will be available under *Ti.Cache.**:

<pre>// will return null
Ti.Cache.get('my_data');

// cache object under "my_data" key for 5 minutes
