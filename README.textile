...
After that, the caching functions will be available under *Ti.Cache.**, just like Titanium native functions.

h3. 1. Get item from cache

<pre>var cached_obj = Ti.Cache.get('my_data');</pre>
...
Developed by "Guilherme Chapiewski":http://github.com/dogweather with contributions from "Robb Shecter":http://github.com/dogweather.
